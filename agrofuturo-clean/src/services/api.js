...
export const api = {
    ...
    return [
      {
        ...
        categoria: "Lagarta",
        severidade: "alta",
        area: "Talhão A - Setor 3",
        coordenadas: [-23.12, -47.35],
        detectadaEm: "2026-03-19T08:30:00",
        tratada: false,
        imagem: "🐛",
      },
      {
        ...
        categoria: "Sugadora",
        severidade: "media",
        area: "Talhão B - Setor 1",
        coordenadas: [-23.14, -47.38],
        detectadaEm: "2026-03-19T06:15:00",
        tratada: false,
        imagem: "🦟",
      },
      {
        id: 3,
        nome: "Pulgão-da-soja",
        cientifico: "Aphis glycines",
        categoria: "Sugadora",
        severidade: "baixa",
        area: "Talhão C - Setor 2",
        coordenadas: [-23.1, -47.4],
        detectadaEm: "2026-03-18T14:20:00",
        tratada: true,
        imagem: "🐝",
      },
      {
        ...
        categoria: "Mosca",
        severidade: "media",
        area: "Talhão A - Setor 1",
        coordenadas: [-23.13, -47.36],
        detectadaEm: "2026-03-18T10:45:00",
        tratada: true,
        imagem: "🦋",
      },
      {
        ...
        categoria: "Percevejo",
        severidade: "alta",
        area: "Talhão D - Setor 4",
        coordenadas: [-23.15, -47.39],
        detectadaEm: "2026-03-17T16:00:00",
        tratada: false,
        imagem: "🪲",
      },
      {
        ...
        categoria: "Broca",
        severidade: "baixa",
        area: "Talhão B - Setor 3",
        coordenadas: [-23.11, -47.37],
        detectadaEm: "2026-03-17T09:30:00",
        tratada: true,
        imagem: "🐛",
      },
      {
        id: 7,
        nome: "Tripes",
        cientifico: "Frankliniella williamsi",
        categoria: "Tripes",
        severidade: "media",
        area: "Talhão C - Setor 1",
        coordenadas: [-23.16, -47.41],
        detectadaEm: "2026-03-16T11:00:00",
        tratada: true,
        imagem: "🦗",
      },
    ];
  ...
  async getVendasSensores() {
    return {
      ...
      porModelo: [
        {
          modelo: "AgroSensor Pro X1",
          vendas: 145,
          receita: 688050,
          margem: 42,
        },
        {
          modelo: "AgroSensor Lite S3",
          vendas: 98,
          receita: 294098,
          margem: 35,
        },
        {
          modelo: "AgroSensor Ultra V2",
          vendas: 67,
          receita: 201067,
          margem: 51,
        },
