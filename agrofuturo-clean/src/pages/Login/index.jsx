      ...
      <div style={styles.left}>
        <div style={styles.leftInner}>
          ...
          <div style={styles.heroText}>
            <h2 style={styles.heroH2}>Agricultura de<br />precisão ao seu alcance</h2>
            <p style={styles.heroP}>
              Monitore seus sensores, detecte pragas e controle
              o consumo de insumos em tempo real — direto do campo.
            </p>
          </div>
      ...
      <div style={styles.right}>
        <div style={styles.formBox}>
          <div style={{ marginBottom: 32 }}>
            ...
            <p style={styles.formSub}>Entre com suas credenciais para continuar</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={styles.fieldGroup}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Link to="/recuperar-senha" style={styles.link}>Esqueci minha senha</Link>
              </div>
          ...
          <p style={styles.cadastroText}>
            Não tem uma conta?{' '}
            <Link to="/cadastro" style={styles.linkStrong}>Criar conta</Link>
          </p>
        </div>
      </div>
    </div>
