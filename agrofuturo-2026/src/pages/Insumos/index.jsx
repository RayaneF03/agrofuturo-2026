...
export default function Insumos() {
  ...
  const cadastroFields = [
    { name: "nome", label: "Nome", type: "text" },
    {
      ...
      label: "Tipo",
      type: "select",
      options: ["Herbicida", "Fungicida", "Inseticida", "Fertilizante"],
    },
    { name: "unidadeMedida", label: "Unidade de medida", type: "text" },
    { name: "custoTotal", label: "Custo total", type: "number" },
    { name: "economia", label: "Economia", type: "number" },
    { name: "ativo", label: "Ativo", type: "toggle" },
    {
      name: "cnpjEmpresa",
    ...
    >
      ...
      >
        <StatCard
          ...
          value={relatorio.totalGasto.toLocaleString("pt-BR")}
          unit="L"
          delta={-8.4}
        ...
        <StatCard
          icon={DollarSign}
          label="Custo Total"
          value={`R$ ${(relatorio.custo / 1000).toFixed(1)}k`}
          delta={-8.4}
          color="var(--accent-yellow)"
        />
        <StatCard
          icon={TrendingDown}
          label="Economia (Precisão)"
          value={`${relatorio.economiaPrecisao}%`}
          delta={3.2}
        ...
        <StatCard
          ...
          value={relatorio.porTalhao.length}
          unit="talhões"
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              background:
                periodo === t.key ? "var(--accent-green)" : "var(--bg-card)",
      ...
      <Card style={{ padding: 20 }}>
        <SectionHeader
          title="Consumo por Tipo de Insumo"
          subtitle="Herbicida, Fungicida e Inseticida — litros/dia"
        />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        <Card style={{ padding: 20 }}>
          <SectionHeader
            ...
            subtitle="Litros utilizados por área"
          />
        ...
        <Card style={{ padding: 20 }}>
          <SectionHeader
            title="Eficiência por Talhão"
            subtitle="% de precisão na aplicação"
          />
      ...
      <CadastroModal
        open={cadastroOpen}
        title="Novo cadastro de insumo"
        subtitle="Inclui CNPJ da empresa e CPF de quem está criando"
        fields={cadastroFields}
        onClose={() => setCadastroOpen(false)}
        onSubmit={() => setCadastroOpen(false)}
        submitLabel="Salvar insumo"
      />
    </div>
  );
}
